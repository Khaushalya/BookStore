<%-- 
    Document   : suppliersHeader
    Created on : Mar 27, 2015, 1:36:18 PM
    Author     : Chami
--%>
    ...
    <div class="col-md-3" style="text-align: right">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu" role="menu">
                ...
                <li class="divider"></li>
                <li><a href="http://localhost:8080/BookStore/Login.jsp">Logout</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-lg-1">
        <img src="http://localhost:8080/BookStore/adminPanel/Images/Page icons/Suppliers.png" class="image" width="100%" alt="Responsive image" data-toggle="tooltip" data-placement="bottom" title="Suppliers" style="opacity: 0.5">
    </div>
    <div class="col-lg-1">
