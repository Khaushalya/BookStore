...
<div class="row">
    ...
    <div class="col-lg-1">
        <img src="http://localhost:8080/BookStore/adminPanel/Images/Page icons/Stocks.png" class="image" width="100%" alt="Responsive image" title="Stocks" data-toggle="tooltip" data-placement="bottom" style="opacity: 0.5">
    </div>
    <div class="col-lg-1">
