 ...
 */
@WebServlet(name = "RemoveSupplier2", urlPatterns = {"/RemoveSupplier2"})
public class RemoveSupplier2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RemoveSupplier2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RemoveSupplier2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("adminPanel/removeSuppliers2.jsp");
